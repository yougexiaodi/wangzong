<template>
    <div style="background:#f1f1f1;">
        ...
        <!--    </div>-->
        <div class="details">
            <div><span>活动时间:&nbsp;&nbsp;</span>2019年10月14日-2020年6月30日</div>
            <div><span>活动对象:&nbsp;&nbsp;</span>中国银行信用卡客户</div>
            <div><span>活动内容:&nbsp;&nbsp;</span>活动期间，中国银行信用卡客户可享指定商户超值优惠权益，通过“中国银行贵州分行”微信公众号-微生活-E卡惠，选择中行信用卡付款，每卡每天每商户限参与一次，各类电子券名额有限，先到先得。（单位卡、公务卡不参加本次活动）。
            </div>
        </div>
